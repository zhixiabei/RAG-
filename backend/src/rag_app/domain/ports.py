...
class VectorStore(Protocol):
    ...
    def search_documents(self, knowledge_base_id: str, vector: list[float], limit: int) -> list[SearchHit]: ...
    def search_keyword_documents(self, knowledge_base_id: str, keywords: list[str], limit: int) -> list[SearchHit]: ...
    def search(self, knowledge_base_id: str, vector: list[float], limit: int, document_ids: Sequence[str] | None = None) -> list[SearchHit]: ...
    def search_keywords(self, knowledge_base_id: str, keywords: list[str], limit: int, document_ids: Sequence[str] | None = None) -> list[SearchHit]: ...
    def delete_document(self, document_id: str) -> None: ...
    def delete_knowledge_base(self, knowledge_base_id: str) -> None: ...
